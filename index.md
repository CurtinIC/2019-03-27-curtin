...
address: "Building 216 : Room 201, Bentley Campus, 6102, Bentley"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "-32.0069186, 115.892092"      # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use http://www.latlong.net/)
humandate: "27 - 29 March 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Behrouz Behesti", "Rebecca Lange", "Matthias Liffers", "Nancy Tippaya"] # boxed, comma-separated list of instructors' names as strings
helper: ["Mark Agostino", "Richard Hosking", "Darcy Jones", "Paula Moolhuijzen", "Kylie Munyard", "Kathryn Napier", "Mohsin Shaikh"]     # boxed, comma-separated list of helpers' names
...
eventbrite:   "57763848225"        # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<strong>Code of Conduct:</strong>  Everyone who participates in Carpentries activities is required
 to conform to the <a href="https://docs.carpentries.org/topic_folders/policies/code-of-conduct.html">Code of Conduct</a>. 
